        ...
        <div>
            <nav id="sidenav-1" className="sidenav" data-mdb-hidden="false">
                <ul className="sidenav-menu">
                    ...
                    <li className="sidenav-item">
                        <a className="sidenav-link"><i className="fas fa-grin fa-fw me-3"></i><span>Category 1</span></a>
                    ...
                    <li className="sidenav-item">
                        <a className="sidenav-link"><i className="fas fa-grin-wink fa-fw me-3"></i><span>Category
                            2</span></a>
